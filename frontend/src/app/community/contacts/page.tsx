...
export default function ContactsPage() {
  ...
  useEffect(() => {
    const fetchContacts = async () => {
      setLoading(true);
      try {
        const response = await fetch("/api/community/contacts");
  ...
  return (
    <div className="contacts-page">
      <h2>Contact Us</h2>
      <p className="contacts-intro">Get in touch with the Dalarnia.fun team. We&apos;d love to hear from you!</p>
      ...
      <div className="contact-methods">
        ...
        <div className="contact-card card">
          <div className="contact-icon">🐦</div>
          <h3>Twitter</h3>
          <p>{contactInfo?.socialMedia?.twitter || "@DalarniaLegends"}</p>
        ...
        <div className="contact-card card">
          <div className="contact-icon">📘</div>
          <h3>Facebook</h3>
          <p>{contactInfo?.socialMedia?.facebook || "DalarniaLegends"}</p>
